...
double detector::thetaenter (double theta) {
	double rthetaenter;
	double Rdet = 6.4;
	double ddet = 500.0;
...
double detector::thetaexit (double theta) {
	double rthetaexit;
	double Rdet = 6.4;
	double ddet = 500.0;
	double Adet, Bdet, Cdet, rad, root;
...
double detector::Lenter (double theta) {
	double rLenter;
	double Rdet = 6.4;
	double ddet = 500.0;
...
double detector::Lexit (double theta) {
	double rLexit;
	double Rdet = 6.4;
	double ddet = 500.0;
...
double detector::Ldet (double theta) {
	double rLdet;
...
//
void detector::intersect(int &dswitch, int &Ndm, Particle &DM){
	// compute polar angle
